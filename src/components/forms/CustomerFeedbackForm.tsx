      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            We value your feedback! Let us know how our A/C services performed
            and help us improve our standards.
          </p>
        </div>
          ...
          {isSubmitted ? (
            <div className="flex flex-col items-center justify-center py-12 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <p className="text-slate-600">
                Your review has been successfully submitted and will be reviewed
                by our team.
              </p>
            </div>
          ) : (
