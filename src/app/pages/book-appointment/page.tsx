              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8 flex-col">
                  ...
                  <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 flex justify-between items-start">
                    <div className="flex gap-4 flex-1">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600 mt-1">{emailAddress || "—"}</p>
                    ...
                    <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 flex justify-between items-start">
                      <div className="flex gap-4 flex-1">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-900">{additionalNotes}</p>
                        </div>
                      </div>
                      <button
                        onClick={() => setCurrentStep(3)}
                ...
                <div className="grid grid-cols-3 gap-3 mb-8">
                  <div className="bg-blue-50 rounded-lg border border-blue-100 p-3 text-center">
                    ...
                    <p className="text-xs font-semibold text-blue-900">Free Diagnostics</p>
                  </div>
                  <div className="bg-blue-50 rounded-lg border border-blue-100 p-3 text-center">
                    <div className="text-blue-600 mb-2 flex justify-center">
                      <svg
                    ...
                    <p className="text-xs font-semibold text-blue-900">12 Month Warranty</p>
                  </div>
                  <div className="bg-blue-50 rounded-lg border border-blue-100 p-3 text-center">
                    <div className="text-blue-600 mb-2 flex justify-center">
                      <svg
                    ...
                    <p className="text-xs font-semibold text-blue-900">Flexible Rescheduling</p>
                  </div>
                </div>
